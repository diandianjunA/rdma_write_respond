//
// Created by 熊嘉晟 on 2024/6/15.
//

#ifndef RDMA_READ_REQUEST_RDMA_COMMON_H
#define RDMA_READ_REQUEST_RDMA_COMMON_H
...
#define DEFAULT_LOCAL_CONNECTION_DESC_PATH "/tmp/write_respond_local_connection_desc_path.txt"
/* Default path to save the remote connection descriptor that should be passed from the other side */
#define DEFAULT_REMOTE_CONNECTION_DESC_PATH "/tmp/write_request_local_connection_desc_path.txt"
/* Default path to read/save the remote mmap connection descriptor that should be passed to the other side */
#define DEFAULT_REMOTE_RESOURCE_CONNECTION_DESC_PATH "/tmp/write_respond_remote_resource_desc_path.txt"
...
#endif //RDMA_READ_REQUEST_RDMA_COMMON_H
